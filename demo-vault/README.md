...
- **Otherwise**, download `nested-properties-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-nested-properties/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `nested-properties-demo-vault-<version>` folder it unzips into.
